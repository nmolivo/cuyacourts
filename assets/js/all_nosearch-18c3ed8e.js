    ...
    (function (e, t) {
        ...
        function C(e, t, n, i, o) {
            ...
            for (d.textContent = "", h = 0; (a = p[h++]);)
                if (i && Ee.inArray(a, i) > -1) o && o.push(a);
                    ...
                    ((c = Ve(a)), (s = w(d.appendChild(a), "script")), c && T(s), n)
                )
        ...
        function O(e, t, r, i) {
            ...
            if (
                ...
                if (u)
                    for (
                        c = s[s.length - 1].ownerDocument, Ee.map(s, q), f = 0;
                        f < u;
                        f++
                    )
                        (l = s[f]),
                ...
                for (r in p)
                    u ||
                        (m
                            ...
                            : (m = Be.access(e, "fxshow", { display: l })),
                            o && (m.hidden = !g),
                            g && b([e], !0),
                            d.done(function () {
                    ...
                    return (
                        ...
                        r(function (r, a, s, u) {
                            var l,
                                ...
                                x = n ? (o || (r ? e : h || i) ? [] : a) : v;
                            if ((n && n(v, x, s, u), i))
                                for (l = y(x, p), i(l, [], s, u), c = l.length; c--;)
                                    (f = l[c]) && (x[p[c]] = !(v[p[c]] = f));
                            if (r) {
                                if (o || e) {
                                    if (o) {
                    ...
                    var i = n.length > 0,
                        ...
                        a = function (r, a, s, u, l) {
                            ...
                            for (
                                ...
                                if (o && c) {
                                    for (
                                        f = 0, a || c.ownerDocument == I || (q(c), (s = !O));
                                        (d = e[f++]);
        ...
        Ee.extend({
            ...
            Ee.each(["height", "width"], function (e, t) {
                Ee.cssHooks[t] = {
                    get: function (e, n, r) {
                        if (n)
                            return !gt.test(Ee.css(e, "display")) ||
                        ...
                        return "undefined" == typeof e.getAttribute
                            ...
                            : ((1 === o && Ee.isXMLDoc(e)) ||
                                (i =
                                    ...
                                    (Ee.expr.match.bool.test(t) ? Ct : undefined)),
                                n !== undefined
                                    ? null === n
            ...
            trigger: function (t, n, r, i) {
                ...
                if (
                    ...
                    if (!i && !f.noBubble && !be(r)) {
                        for (
                            u = f.delegateType || h, jt.test(u + h) || (a = a.parentNode);
                            a;
                            a = a.parentNode
                        )
                            p.push(a), (s = a);
        ...
        Ee.parseXML = function (t) {
            ...
            return (
                ...
                Ee.error(
                    "Invalid XML: " +
                    (r
                        ? Ee.map(r.childNodes, function (e) {
                    ...
                    function r(t, n, r, s) {
                        ...
                        c ||
                            ((c = !0),
                                ...
                                (C.status = t),
                                (C.statusText = (n || T) + ""),
                                l ? y.resolveWith(g, [d, T, C]) : y.rejectWith(g, [C, T, p]),
                                C.statusCode(x),
                                (x = undefined),
                                f &&
                                m.trigger(l ? "ajaxSuccess" : "ajaxError", [C, h, l ? d : p]),
                                v.fireWith(g, [C, T]),
                                f &&
        ...
        Ee.ajaxSetup({
            ...
            jsonpCallback: function () {
                var e = Gt.pop() || Ee.expando + "_" + Lt.guid++;
                return (this[e] = !0), e;
            },
        }),
            ...
            Ee.each(["top", "left"], function (e, t) {
                Ee.cssHooks[t] = R(ve.pixelPosition, function (e, n) {
                    if (n)
                        return (n = P(e, t)), ut.test(n) ? Ee(e).position()[t] + "px" : n;
                });
            }),
        ...
        return (
            (Ee.noConflict = function (t) {
                return (
                    e.$ === Ee && (e.$ = en), t && e.jQuery === Ee && (e.jQuery = Zt), Ee
                );
            }),
